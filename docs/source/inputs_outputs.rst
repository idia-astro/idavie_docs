...
* **IDVS** iDaVIE Video Script created by iDaVIE, stored in :literal:`Output/VideoScripts`. Used to create videos.
* **MP4** videos created by iDaVIE using IDVS, stored in :literal:`Output/Video`.